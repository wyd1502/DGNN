...
for i in range(args.n_runs):
  ...
  dgnn.memory_s.__init_memory__()
  dgnn.memory_g.__init_memory__()
  ...
  for epoch in range(NUM_EPOCH):
    ...
    val_ap, val_auc = eval_edge_prediction(model=dgnn,
    ...
    nn_val_ap, nn_val_auc = eval_edge_prediction(model=dgnn,negative_edge_sampler=val_rand_sampler,
  ...
  test_ap, test_auc = eval_edge_prediction(model=dgnn, negative_edge_sampler=test_rand_sampler,
  ...
  nn_test_ap, nn_test_auc = eval_edge_prediction(model=dgnn, negative_edge_sampler=nn_test_rand_sampler,
